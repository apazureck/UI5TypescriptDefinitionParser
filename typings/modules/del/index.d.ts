...
declare module '~del~pinkie-promise~es6-promise/dist/es6-promise' {
...
declare module '~del~pinkie-promise/index' {
import { Promise } from '~del~pinkie-promise~es6-promise/dist/es6-promise';

export = Promise;
}

// Generated by typings
// Source: https://raw.githubusercontent.com/MrHen/typings-del/6870e56e4bb674290c131ee634e22aea7e31c1cd/index.d.ts
declare module 'del' {
import Promise = require('~del~pinkie-promise/index');
...
function del(patterns: string | string[], opts?: del.Options): Promise<string[]>;
